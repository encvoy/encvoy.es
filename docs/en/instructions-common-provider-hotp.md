...
The main difference between **HOTP** and **TOTP** is that codes are not time-dependent. Each use of a code increments the counter, and the server verifies the entered code against the current counter value.
