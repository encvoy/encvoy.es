...
5. Specify the required [application parameters](#full-parameters-reference):
    ...
    - **Application Name**,
    - **Application Address** in the format `protocol://domain-name:port`,
...
5. Open the action menu for the user whose permissions you want to change.
...
3. Click on the application panel.
4. The application profile will open.
5. Open the action menu for the user whose sessions you want to terminate.
...
3. Click on the application panel.
4. The application profile will open.
5. Open the action menu for the user you want to remove from the application.
