...
Below are instructions for assigning the **Manager** and **Administrator** system roles.
...
#### Assigning "Administrator" System Permissions
...
### How to Delete a User in Encvoy ID
...
1. Click **Delete account** in one of the interfaces:
     ...
     - In the user action menu on the **Users** tab.  
        ...
        <img src="./images/manage-user-16.webp" alt="User action menu in Encvoy ID" style="max-width:600px; width:100%">

     - In the user profile within the **Other Actions** block.  

        <img src="./images/manage-user-15.webp" alt="User profile action menu in Encvoy ID" style="max-width:600px; width:100%">
