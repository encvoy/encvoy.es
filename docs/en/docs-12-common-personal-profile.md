...
4. Add a photo using one of the following methods:
    ...
    > 📌 If there are no linked external system identifiers with a photo in the profile, the **Available** button will be hidden.
...
2. Find the **Contacts** block and click **Edit** on the **Phone Number** panel.  
    ...
    <img src="./images/personal-profile-07.webp" alt="Button for editing phone number in the Encvoy ID personal profile" style="max-width:600px; width:100%">

3. The edit form will open.

    <img src="./images/personal-profile-08.webp" alt="Editing phone number in the Encvoy ID personal profile" style="max-width:600px; width:100%">
