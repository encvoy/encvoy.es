...
The "Profile" module provides management of personal user data and access settings. It includes functions for editing personal information, privacy settings, managing application permissions, and viewing the activity log. The module also provides access to the public application catalog.
